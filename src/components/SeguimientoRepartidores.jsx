...
export default function SeguimientoRepartidores({ fecha, vendedorEmail }) {
  ...
  const [grupos, setGrupos] = useState([]); // [{repartidor, total, entregados, proximo, pedidos}]

  // Normaliza números AR al formato que acepta WhatsApp: 549AAxxxxxxxx (sin '+')
  ...
  // Devuelve una lista de teléfonos únicos (principal y alternativo si existen)
  const getPhones = (p) => {
            ...
            <div className="mt-3">
              {g.proximo ? (
                <div className="p-3 rounded-lg bg-base-100">
                  ...
                  {/* Teléfonos: principal y alternativo (si hay) */}
